...
JSON Session store (api/models.py), not on NasTech-Agent's SQLite.

Behavior parity reference: gateway/run.py:_handle_*_command in
the NasTech-Agent repo.
"""
...
def session_status(session_id: str) -> dict[str, Any]:
    ...
    try:
        ...
        nastech_home = str(get_nastech_home_for_profile(profile))
    except Exception:
        nastech_home = ''
    return {
