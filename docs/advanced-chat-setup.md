...
NasTech Gateway API server while preserving the existing WebUI `/api/chat/start`
...
The bridge is best used by operators who already run NasTech Gateway/API Server
