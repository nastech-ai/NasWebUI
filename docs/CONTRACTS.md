...
- [`docs/rfcs/nastech-run-adapter-contract.md`](rfcs/nastech-run-adapter-contract.md):
...
- [`docs/architecture/agent-api-contract.md`](architecture/agent-api-contract.md):
  current audit of WebUI dependencies on the NasTech-Agent source checkout and
