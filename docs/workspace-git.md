...
process is started with `NASMUSICUI_WORKSPACE_GIT_DESTRUCTIVE=1`.
...
Without `NASMUSICUI_WORKSPACE_GIT_DESTRUCTIVE=1`, WebUI can:
...
These actions are blocked unless `NASMUSICUI_WORKSPACE_GIT_DESTRUCTIVE=1` is set:
