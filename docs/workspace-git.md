...
process is started with `NASWEBUI_WORKSPACE_GIT_DESTRUCTIVE=1`.
...
Without `NASWEBUI_WORKSPACE_GIT_DESTRUCTIVE=1`, WebUI can:
...
These actions are blocked unless `NASWEBUI_WORKSPACE_GIT_DESTRUCTIVE=1` is set:
