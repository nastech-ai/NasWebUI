...
<dict>
    ...
    <string>/Users/yourname/.nastech/webui/launchd-stdout.log</string>

    <key>StandardErrorPath</key>
    <string>/Users/yourname/.nastech/webui/launchd-stderr.log</string>
...
- ``/health?deep=1`` — readiness probe that briefly acquires the stream lock,
  reads the sidebar/session path, reads projects state, and touches NasTech
