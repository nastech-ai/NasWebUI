    ...
    try{
      ...
      const requestPromise=(async()=>{
        ...
        if(!res.ok){
          ...
          // and for subpath mounts like /nastech/, where /login escapes to the site root.
...
// Canonical NasTech mutators plus MCP filesystem aliases that can create/edit files.
