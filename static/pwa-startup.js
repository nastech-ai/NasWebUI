...
(function(){
  ...
  syncMode();
  window.addEventListener('online',function(){syncMode();dispatch('nastech:pwa-connection-change',{online:true});});
  window.addEventListener('offline',function(){syncMode();dispatch('nastech:pwa-connection-change',{online:false});});
