...
| Surface | Status |
|---|---|
| **NasTech CLI parity** | ✅ Complete — every CLI workflow has a web equivalent |
...
- [x] NasTech Control Center modal (centralized actions)
...
| NasTech Agent dashboard cross-link | #1459 | Detect a running NasTech Agent and surface link in nav |
...
- Plugin marketplace — NasTech skills cover this surface
