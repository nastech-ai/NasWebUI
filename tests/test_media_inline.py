...
class TestMediaEndpointUnit(unittest.TestCase):
        ...
        with mock.patch.object(
            ...
            self.assertFalse(
                routes._path_is_within_root(
                    ...
                    pathlib.Path("C:/Users/agent/.nastech"),
                )
            )
    ...
    def test_active_workspace_carveout_gated_against_naswebui_roots(self):
        ...
        with tempfile.TemporaryDirectory() as home:
            ...
            self.assertEqual(
                ...
                "NasTech home (carve-out must be gated against internal roots)",
            )
    ...
    def test_named_profile_workspace_serves_but_profile_secrets_denied(self):
        ...
        with tempfile.TemporaryDirectory() as home:
            base = pathlib.Path(home) / ".nastech"
    ...
    def test_media_allowed_roots_env_var_serves_outside_naswebui_root(self):
        ...
        with tempfile.TemporaryDirectory() as home, tempfile.TemporaryDirectory() as extra:
            ...
            self.assertEqual(
                handler.status, 200,
                "MEDIA_ALLOWED_ROOTS media outside NasTech roots must still serve",
            )
...
class TestMediaEndpointIntegration(unittest.TestCase):
    ...
    def test_webui_state_secret_files_denied(self):
        ...
        they live under an allowed root (the whole NasTech home is allowed).
