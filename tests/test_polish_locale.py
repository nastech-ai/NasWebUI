...
def test_polish_settings_detail_descriptions_are_translated():
    ...
    expected = [
        ...
        "settings_desc_sync_insights: 'Odzwierciedla zużycie tokenów WebUI w state.db, dzięki czemu nastech /insights uwzględnia dane sesji przeglądarki. Domyślnie wyłączone.'",
