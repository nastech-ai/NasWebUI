...
# ── #668: UID/GID auto-detect from nastech-home shared volume (two-container) ──
...
def test_668_gid_autodetect_checks_nastech_home():
    """docker_init.bash must probe nastech-home dirs for GID in two-container setups (#668)."""
