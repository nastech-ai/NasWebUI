...
def test_manual_cron_run_uses_execution_profile_but_persists_to_owning_store(monkeypatch):
    ...
    routes._run_cron_tracked(
        {"id": "job617"},
        profile_home="/nastech/default",
        execution_profile_home="/nastech/profiles/research",
    )

    assert events == [
        ("run", "job617", "/nastech/profiles/research"),
        ("enter", "/nastech/default"),
        ("save", "job617", "output"),
        ("mark", "job617", True, None),
        ("exit", "/nastech/default"),
    ]
