...
Covers:
  ...
  8. NASWEBUI_ONBOARDING_OPEN=1 bypasses the check entirely
...
# `NASWEBUI_TRUST_FORWARDED_FOR=1`, and only loopback counts as local when an
...
class TestOnboardingIPLogic:
    ...
    def test_open_env_bypasses_check(self):
        """NASWEBUI_ONBOARDING_OPEN=1 allows any IP."""
