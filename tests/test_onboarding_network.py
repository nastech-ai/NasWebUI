...
Covers:
  ...
  8. NASMUSICUI_ONBOARDING_OPEN=1 bypasses the check entirely
...
# `NASMUSICUI_TRUST_FORWARDED_FOR=1`, and only loopback counts as local when an
...
class TestOnboardingIPLogic:
    ...
    def test_open_env_bypasses_check(self):
        """NASMUSICUI_ONBOARDING_OPEN=1 allows any IP."""
