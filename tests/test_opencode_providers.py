...
def _models_with_env_key(monkeypatch, env_var, expected_provider_display):
    """Helper: fake nastech_cli unavailable, set an env var, check detection."""
    # Force the env-var fallback path by making nastech_cli import fail
...
def test_live_models_handler_delegates_to_provider_model_ids():
    ...
    assert "provider_model_ids" in routes_src, (
        "_handle_live_models must call nastech_cli.models.provider_model_ids() "
