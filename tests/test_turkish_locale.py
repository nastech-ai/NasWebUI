...
def test_turkish_locale_includes_representative_translations():
    ...
    expected = [
        ...
        "onboarding_title: 'NasTech Web Kullanıcı Arayüzüne Hoş Geldiniz'",
    ]
...
def test_turkish_settings_detail_descriptions_are_translated():
    ...
    expected = [
        ...
        "settings_desc_sync_insights: 'WebUI belirteci kullanımını state.db\\'ye yansıtır, böylece nastech /insights tarayıcı oturum verilerini içerir. Varsayılan olarak kapalıdır.'",
