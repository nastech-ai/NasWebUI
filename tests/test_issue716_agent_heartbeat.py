"""Regression coverage for #716 NasTech agent/gateway heartbeat monitor."""
...
def _runtime_status(**overrides):
    payload = {
        ...
        "pid": 12345,
        "argv": ["nastech", "gateway", "--token", "secret-token"],
        "command": "nastech gateway --token secret-token",
        "executable": "/home/user/.nastech/NasTech-Agent/venv/bin/python",
        "env": {"API_KEY": "secret"},
    }
...
def test_agent_health_uses_root_gateway_state_when_nastech_home_is_profile(monkeypatch, tmp_path):
