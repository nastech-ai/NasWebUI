...
class TestLiveModelsProviderNormalization:
    ...
    def test_alias_resolver_works_without_nastech_cli(self):
        """Normalization must work even when nastech_cli is not importable —
...
class TestKnownProvidersUnaffected:
    ...
    def test_custom_unaffected(self):
        ...
        try:
            ...
            pass  # NasTech-Agent not available in this env — skip
...
class TestOllamaAliasEdgeCase:
    ...
    def test_ollama_not_in_provider_aliases_as_ollama(self):
        ...
        try:
            ...
            pass  # NasTech-Agent not available
