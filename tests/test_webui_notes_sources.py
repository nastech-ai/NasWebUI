...
def test_joplin_search_notes_returns_safe_snippets(monkeypatch):
    ...
    def fake_get(path, params=None):
        ...
        return {"items": [{
            "id": "abc123def4567890",
            "title": "NasTech Context",
            "body": "This is a long NasTech context note with useful details.",
            "parent_id": "folder123",
            "updated_time": 123,
        }]}
    ...
    results = routes._joplin_search_notes("NasTech")

    assert results == [{
        "id": "abc123def4567890",
        "title": "NasTech Context",
        "snippet": "This is a long NasTech context note with useful details.",
        "parent_id": "folder123",
        "updated_time": 123,
        "source": "joplin",
    }]
