...
SOUL.md lives at NASTECH_HOME/SOUL.md (not in the memories/ subdirectory).
This test file verifies:
- GET /api/memory returns soul content, path, and mtime
- POST /api/memory/write with section="soul" writes to NASTECH_HOME/SOUL.md
...
def test_memory_write_soul_roundtrip():
    ...
    # Path should be at NASTECH_HOME/SOUL.md
...
def test_memory_write_soul_path_not_in_memories_dir():
    """The SOUL.md file should be at NASTECH_HOME/SOUL.md, not memories/SOUL.md."""
