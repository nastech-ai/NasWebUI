...
in the NasTech agent CLI.  WebUI must expose them in Settings → Providers and
...
def _install_fake_nastech_cli(monkeypatch, *, authenticated: bool = True, model_ids: list[str] | None = None):
